...
class SimpleTagger(Model):
    ...
    def __init__(self, vocab: Vocabulary,
        ...
        self._fbeta_metric = FBetaMeasure(average='macro')
    ...
    def forward(self,  # type: ignore
        ...
        if tags is not None:
            ...
            if self._fbeta_metric is not None:
                self._fbeta_metric(logits, tags, mask.float())
    ...
    def get_metrics(self, reset: bool = False) -> Dict[str, float]:
        ...
        metrics_to_return.update(self._fbeta_metric.get_metric())
